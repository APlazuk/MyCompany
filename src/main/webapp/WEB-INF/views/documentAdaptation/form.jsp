...
<table width="100%">
    <th width="50%">
            ...
            <img width="40px"  height="150px" src="/unspecified-document/addDocument/{fileId}"/>

    </th>

    <th width="50%">

<form:form method="post" modelAttribute="document" action="/addDocument/{fileId}" id="add-document-form"><br/>
    <form:select path="documentTypeName" itemLabel="name" itemValue="id" items="${types}"/>
